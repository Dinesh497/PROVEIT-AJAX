...
- (void)viewDidLoad
{
    ...
    _HeadersSectionOne = [[NSArray alloc] initWithObjects:@"Begin",@"Eind", nil];
    _DetailsSectionOne = [[NSArray alloc] initWithObjects:@"12:00", @"13:00", nil];
...
-(NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section{
    if(section == 0){
        // De eerste sectie heeft twee rijen nodig voor begin- en eindtijd
        return 2;
    } else{
